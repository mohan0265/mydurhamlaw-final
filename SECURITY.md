...
Caseway implements a year-based access control system:
...
**Security Team**: security@casewaylaw.ai  
**General Support**: support@casewaylaw.ai  
...
_This security policy is reviewed and updated quarterly to reflect current best practices and emerging threats. Users will be notified of any significant changes._
