...
`
  ...
  const messages = [
    ...
    ...recent.reverse().map((m) => ({ role: m.role === 'assistant' ? 'assistant' : 'user', content: m.content })),
    { role: 'user', content: latest_user_message }
  ]

  let aiText = 'Thanks for the details. I will escalate this for a human to review.'
  try {
