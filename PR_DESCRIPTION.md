...
**Ready to merge**: This PR establishes the foundation for authentic Caseway academic calendar functionality with proper data sourcing and clean architecture.
