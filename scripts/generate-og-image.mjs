...
async function generateOG() {
  ...
  // Text centered
  // Wordmark: MyDurhamLaw (Purple #5B2AAE) approx 80px font
  ...
  <svg width="${width}" height="${height}">
    ...
    <text x="50%" y="420" text-anchor="middle" class="title">MyDurhamLaw</text>
  ...
  .composite([
    { input: iconBuffer, top: 120, left: (width - 200) / 2, resize: { width: 200, height: 200 } }, // Icon centered top
