...
// This version works in BOTH Vite (DurmahStandalone) and Next.js (mydurhamlaw-final).
 ...
 * (DurmahStandalone fallback /.netlify/functions/realtime-session still works if you set it)
 */
const viteEnv =
...
const SESSION_ENDPOINT =
  ...
  "/api/realtime-session"; // <-- Next.js default
