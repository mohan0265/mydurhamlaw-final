...
import { Shield, Heart, BookOpen, Mail, Phone, MapPin, ExternalLink } from 'lucide-react'
    ...
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/legal/ethics" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 flex items-center group">
              ...
              <li>
                <Link href="/legal/academic-integrity" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/legal/research" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Legal Research Hub
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/getting-started" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Getting Started Guide
                </Link>
              </li>
              <li>
                <Link href="/feedback" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Send Feedback
                </Link>
              </li>
              <li>
                <Link href="/community" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Student Community
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 pt-8 mb-8">
          <h5 className="text-sm font-semibold text-gray-400 mb-4">Popular Searches</h5>
          <div className="flex flex-wrap gap-3 text-xs">
            <Link href="/durham-law-study-guide" className="bg-gray-800 hover:bg-gray-700 px-3 py-1 rounded-full transition-colors duration-200">
              Durham Law Study Guide
            </Link>
            <Link href="/uk-law-degree-help" className="bg-gray-800 hover:bg-gray-700 px-3 py-1 rounded-full transition-colors duration-200">
              UK Law Degree Help
            </Link>
            ...
            <Link href="/uk-law-faculties" className="bg-gray-800 hover:bg-gray-700 px-3 py-1 rounded-full transition-colors duration-200">
              UK Law Faculties
            </Link>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2024 MyDurhamLaw. Built with care for legal excellence. All rights reserved.
          </p>
