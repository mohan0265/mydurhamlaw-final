    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-gray-50">
          <div className="bg-white rounded-lg shadow-sm p-12 max-w-3xl mx-auto">
            {/* Title Page Section */}
            <div className="text-center mb-12 pb-12 border-b-2 border-gray-200">
              ...
              <p className="text-xl mb-6" style={{ fontFamily: 'Times New Roman, serif' }}>
                {assignment.module_name || 'Law Assignment'}
              </p>
              <p className="text-gray-600 mb-2" style={{ fontFamily: 'Times New Roman, serif' }}>
            ...
            <div className="mt-12 pt-8 border-t-2 border-gray-200">
              ...
              {showAIDeclaration && (
                <div className="space-y-4">
                  <p style={{ fontFamily: 'Times New Roman, serif', fontSize: '12pt' }}>
                    In accordance with Durham Law School's Generative AI Policy (2025-26), 
                    the following AI assistance was used in preparing this assignment:
                  </p>
                  
                  {aiUsageLog.length > 0 ? (
                    <ol className="list-decimal list-inside space-y-2">
                      {aiUsageLog.map((log, idx) => (
                        <li key={idx} style={{ fontFamily: 'Times New Roman, serif', fontSize: '12pt' }}>
                          {log}
                        </li>
                      ))}
                    </ol>
                  ) : (
                    <p className="text-gray-600 italic" style={{ fontFamily: 'Times New Roman, serif', fontSize: '12pt' }}>
                      No AI assistance was logged for this assignment.
                    </p>
                  )}
                  
                  <p className="italic mt-6" style={{ fontFamily: 'Times New Roman, serif', fontSize: '12pt' }}>
                    All substantive content and analysis is the student's original work. 
                    AI tools were used only for permitted purposes as outlined in the assessment guidelines. 
                    The student takes full responsibility for the accuracy of all content.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="p-6 border-t border-gray-200 bg-white rounded-b-lg flex items-center justify-between">
