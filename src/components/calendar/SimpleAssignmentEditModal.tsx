...
export default function SimpleAssignmentEditModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 animate-in fade-in zoom-in duration-200" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
             <div>
               <label className="block text-sm font-medium mb-1 text-gray-700">Word Limit</label>
               <input
                 type="number"
             ...
             <div>
               <label className="block text-sm font-medium mb-1 text-gray-700">Effort (Hours)</label>
               <input
                 type="number"
