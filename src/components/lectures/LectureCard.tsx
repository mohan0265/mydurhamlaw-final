              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="flex flex-wrap items-center justify-end gap-1.5">
                  ...
                  {lecture.panopto_url ? (
                    ...
                    <span className="bg-gray-50 text-gray-400 text-[10px] px-1.5 py-0.5 rounded font-medium">
                      No link
                    </span>
                  )}
                  ...
                  {lecture.status === "ready" ? (
                    <span className="bg-green-50 text-green-600 text-[10px] px-1.5 py-0.5 rounded font-medium">
                      Transcript ready
                    </span>
                    ...
                    <span className="bg-yellow-50 text-yellow-600 text-[10px] px-1.5 py-0.5 rounded font-medium">
                      Processing...
                    </span>
                  )}
                </div>
