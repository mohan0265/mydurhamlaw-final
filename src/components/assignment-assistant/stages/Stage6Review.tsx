...
export default function Stage6Review({
  assignmentId,
  briefData,
  aiUsageLog,
  finalDraft,
...
`;
  ...
  const downloadDraft = async () => {
    try {
      ...
      const doc = new Document({
        ...
        description: "Generated by Caseway Assignment Assistant",
        sections: [
          {
            properties: {},
            children: [
  ...
  const handleSubmit = () => {
    ...
    onComplete();
    toast.success(
      "Assignment workflow complete! Good luck with your submission! 🎓",
    );
  };
    ...
    <div className="h-full bg-white rounded-xl shadow-lg p-6 flex flex-col">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg">
        ...
        <div className="space-y-1 text-sm">
          <p>
            <strong>Module:</strong> {briefData?.module_code || "Not specified"}{" "}
            {briefData?.module_name || ""}
          </p>
          <p>
            <strong>Deadline:</strong>{" "}
            {briefData?.due_date
              ? new Date(briefData.due_date).toLocaleDateString("en-GB", {
          ...
          <p>
            ...
            {briefData?.word_limit || "Not specified"} words
          </p>
          <p>
            <strong>Citation Style:</strong> OSCOLA
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto mb-6 space-y-3">
        ...
        <label className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600">
              Checked that essay is within ±10% of word limit (including
        ...
        <label className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600">
              Footnotes and bibliography follow OSCOLA standard
            </p>
          </div>
        </label>
        ...
        <label className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600">
              1.5 spacing, proper formatting, tutor name included
            </p>
          </div>
        </label>
        ...
        <label className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600">
              I understand my work will be checked and I have not plagiarized
            </p>
          </div>
        </label>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-700 mb-3">
                Durham's "Selective Use" policy requires you to cite all AI
                assistance. We've tracked your usage:
              </p>
        ...
        <label className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600">
              File format correct (.doc/.docx), deadline noted
            </p>
          </div>
        </label>
      </div>
