  ...
  return (
    <div className="bg-white flex flex-col">
      <Head>
        ...
        <meta
          property="og:image"
          content="https://mydurhamlaw.com/og/og-default.png"
        />
              ...
              {user ? (
                <>
                  ...
                  <Link href="/pricing" prefetch={false}>
                    <Button
                      variant="outline"
                      className="border-white text-white hover:bg-white/10 px-8 py-3 text-lg w-full sm:w-auto"
                    >
                      View Plans
                    </Button>
                  </Link>
                ...
                <>
                  ...
                  <Link href="/login?next=/pricing" prefetch={false}>
                    <Button
                      variant="outline"
                      className="border-white text-white hover:bg-white/10 px-8 py-3 text-lg w-full sm:w-auto"
                    >
