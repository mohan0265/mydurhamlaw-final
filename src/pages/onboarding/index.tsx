...
export default function OnboardingHub() {
        ...
        return (
          <div className="bg-blue-50 p-4 rounded-lg mt-3 text-sm space-y-3 border border-blue-100">
            <p className="font-semibold text-blue-900">
              How to sync your timetable:
            </p>
            <ol className="list-decimal pl-5 space-y-2 text-blue-800">
              <li>
                Log in to{" "}
                <a
                  href="https://mytimetable.durham.ac.uk"
                  target="_blank"
                  className="underline"
                >
                  MyTimetable Durham
              ...
              <li>
                Copy the <strong>subscription URL</strong> (ends in .ics).
              </li>
            ...
            <div className="mt-2">
              <img
                src="/images/yaag.png"
                alt="Timetable Guide"
                className="rounded-lg border border-blue-200 shadow-sm max-w-full h-auto"
              />
            </div>
          </div>
        );
        ...
        return (
          <div className="bg-orange-50 p-4 rounded-lg mt-3 text-sm space-y-3 border border-orange-100">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-orange-800">
              ...
              <li>
                Click "New Assignment" and fill in the details (or upload the
                brief!).
              </li>
            </ol>
            <div className="mt-2">
              <img
                ...
                alt="Dashboard Guide"
                className="rounded-lg border border-orange-200 shadow-sm max-w-full h-auto"
              />
            </div>
          </div>
        );
        ...
        return (
          <div className="bg-pink-50 p-4 rounded-lg mt-3 text-sm space-y-3 border border-pink-100">
            ...
            <p className="text-pink-800">
              Connect with family or friends to share your study status without
              feeling monitored.
            </p>
            <div className="mt-2">
              <img
                src="/images/awy.png"
                alt="AWY Guide"
                className="rounded-lg border border-pink-200 shadow-sm max-w-full h-auto"
              />
            </div>
          </div>
        );
  ...
  return (
    <>
      <Head>
        <title>Onboarding Hub - Caseway</title>
      </Head>
                  ...
                  <div className="p-5 flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        >
                          {task.completed ? "Visit Again" : "Go to Page"}{" "}
          ...
          {data.percent === 100 && (
            <div className="mt-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-8 text-center text-white shadow-xl">
              ...
              <h2 className="text-2xl font-bold mb-2">
                You're officially a Caseway pro!
              </h2>
              <p className="text-green-100 mb-6 max-w-md mx-auto">
                You've unlocked all the tools you need for academic success.
                Keep exploring and checking in with Durmah.
              </p>
              <button
