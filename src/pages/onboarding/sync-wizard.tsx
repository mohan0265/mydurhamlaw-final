...
export default function SyncWizardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <Head>
        <title>Sync Your University Life - Caseway</title>
      </Head>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Connect your MyTimetable and Blackboard calendars to keep everything
          in one place.
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <details className="mt-2 text-xs text-gray-500 cursor-pointer">
                  <summary className="hover:text-purple-600 font-medium">
                  ...
                  <ol className="list-decimal pl-4 mt-2 space-y-1 ml-2">
                    ...
                    <li>
                      Open <strong>Settings</strong> (top right)
                    </li>
                    <li>
                      Look for <strong>Subscribe</strong> or{" "}
              ...
              <div>
                ...
                <details className="mt-2 text-xs text-gray-500 cursor-pointer">
                  <summary className="hover:text-orange-600 font-medium">
                    How to find this URL?
                  </summary>
                  <ol className="list-decimal pl-4 mt-2 space-y-1 ml-2">
                    <li>
                      Go to{" "}
                      <a
                        href="https://blackboard.durham.ac.uk/ultra/calendar"
                        target="_blank"
                        rel="noreferrer"
                    ...
                    <li>
                      Click <strong>Calendar Settings</strong> (gear icon)
                    </li>
                    <li>
                      Select <strong>Share Calendar</strong>
                    </li>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left space-y-3">
                ...
                {syncResult.results?.blackboard.status === "success" && (
                  <div className="flex items-start gap-2 text-sm">
                    ...
                    <span className="text-gray-600">
                      Imported {syncResult.results.blackboard.assessments}{" "}
                      assignments
                    </span>
                  </div>
                )}
                {(syncResult.results?.timetable.status === "failed" ||
                  syncResult.results?.blackboard.status === "failed") && (
                  <div className="flex items-start gap-2 text-sm text-red-600 mt-2 bg-red-50 p-2 rounded">
                    <AlertCircle className="w-4 h-4 mt-0.5" />
                    <span>
                      Some calendars failed to sync. Please check your URLs and
                      try again later.
                    </span>
                  </div>
                )}
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-500">
            Your calendar data is stored securely and only used to help you
            study.
            <br />
            You can re-sync or update your URLs in your profile settings
            anytime.
          </p>
        </div>
      </div>
