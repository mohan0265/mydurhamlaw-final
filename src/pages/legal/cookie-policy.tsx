...
const CookiePolicyPage = () => {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-gray-800">
      ...
      <p className="mb-4">
        This Cookie Policy explains how <strong>Caseway</strong> uses cookies
        and similar technologies to improve your experience on our platform.
      </p>
      ...
      <p className="mb-4">
        ...
        website. They help us remember your preferences and enhance your user
        experience.
      </p>
      ...
      <p className="mb-4">
        ...
        However, please note that disabling cookies may limit some features of
        the platform.
      </p>
