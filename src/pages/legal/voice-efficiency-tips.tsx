...
export default function VoiceEfficiencyTips() {
  return (
    <>
      <Head>
        <title>Durmah Voice Efficiency Tips | MyDurhamLaw</title>
        <meta name="description" content="Learn how to get maximum value from Durmah Voice in just 10 minutes with focused habits and smart tutor-style prompts." />
      </Head>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-slate-200 overflow-hidden relative mb-12">
             ...
             <div className="relative z-10 text-center md:text-left">
                ...
                <p className="text-lg md:text-xl text-slate-600 font-bold leading-relaxed mb-4">
                  Durmah Voice works best when you use it like a smart tutor session — focused, interactive, and time-boxed.
                </p>
                <p className="text-slate-500 font-medium">
                   These quick habits help you learn faster and keep voice time efficient.
                </p>
             </div>
          </div>
          ...
          <div className="space-y-8 mb-16">
             ...
             <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm transition-all hover:shadow-md">
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h2 className="text-xl font-black text-slate-900">1. Start with a 1-sentence goal</h2>
                </div>
                <div className="space-y-4">
                   <p className="text-slate-500 text-sm font-bold uppercase tracking-widest px-1">Say this first:</p>
                   <ul className="space-y-3">
                      {[
                        ...
                        <li key={i} className="bg-slate-50 p-4 rounded-xl border border-slate-100 font-bold text-slate-700 italic flex gap-3">
                   ...
                   <div className="mt-6 pt-6 border-t border-slate-100">
                      <p className="text-sm font-bold text-slate-900 mb-1">Why it works:</p>
                      <p className="text-slate-600 text-sm leading-relaxed">A clear goal makes Durmah ask the right questions and saves time.</p>
                   </div>
                </div>
             </div>
             ...
             <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm transition-all hover:shadow-md">
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h2 className="text-xl font-black text-slate-900">2. Ask for 3 questions at a time (not 20)</h2>
                </div>
                <div className="space-y-4">
                   <p className="text-slate-500 text-sm font-bold uppercase tracking-widest px-1">Best prompt:</p>
                   <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 font-bold text-slate-700 italic flex gap-3">
                      <span className="text-indigo-400">“</span>
                      Ask me 3 exam-style questions. After each answer, tell me what’s missing and ask the next.
                      <span className="text-indigo-400">”</span>
                   </div>
                   <div className="mt-6 pt-6 border-t border-slate-100">
                      <p className="text-sm font-bold text-slate-900 mb-1">Why it works:</p>
                      <p className="text-slate-600 text-sm leading-relaxed">You get fast feedback loops and don’t waste time on long monologues.</p>
                   </div>
                </div>
             </div>
             ...
             <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm transition-all hover:shadow-md">
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h2 className="text-xl font-black text-slate-900">3. Use “Stop me when I go wrong”</h2>
                </div>
                <div className="space-y-4">
                   <p className="text-slate-500 text-sm font-bold uppercase tracking-widest px-1">Best prompt:</p>
                   <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 font-bold text-slate-700 italic flex gap-3">
                      <span className="text-indigo-400">“</span>
                      Stop me as soon as my reasoning goes off track, then help me correct it.
                      <span className="text-indigo-400">”</span>
                   </div>
                   <div className="mt-6 pt-6 border-t border-slate-100">
                      <p className="text-sm font-bold text-slate-900 mb-1">Why it works:</p>
                      <p className="text-slate-600 text-sm leading-relaxed">This mimics a real tutor and builds exam-ready thinking.</p>
                   </div>
                </div>
             </div>
             ...
             <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm transition-all hover:shadow-md">
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h2 className="text-xl font-black text-slate-900">4. Speak in IRAC / structured steps</h2>
                </div>
                <div className="space-y-4">
                   <p className="text-slate-500 text-sm font-bold uppercase tracking-widest px-1">Best prompt:</p>
                   <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 font-bold text-slate-700 italic flex gap-3">
                   ...
                   <div className="mt-6 pt-6 border-t border-slate-100">
                      <p className="text-sm font-bold text-slate-900 mb-1">Why it works:</p>
                      <p className="text-slate-600 text-sm leading-relaxed">You build reliable structure under pressure.</p>
                   </div>
                </div>
             </div>
             ...
             <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm transition-all hover:shadow-md">
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h2 className="text-xl font-black text-slate-900">5. End every session with a summary + next drills</h2>
                </div>
                <div className="space-y-4">
                   <p className="text-slate-500 text-sm font-bold uppercase tracking-widest px-1">Best prompt:</p>
                   <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 font-bold text-slate-700 italic flex gap-3">
                      <span className="text-indigo-400">“</span>
                      Summarise my mistakes in 5 bullets, then give me 3 drills to practise next.
                      <span className="text-indigo-400">”</span>
                   </div>
                   <div className="mt-6 pt-6 border-t border-slate-100">
                      <p className="text-sm font-bold text-slate-900 mb-1">Why it works:</p>
                      <p className="text-slate-600 text-sm leading-relaxed">You leave with action steps, not just conversation.</p>
                   </div>
                </div>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-indigo-600 rounded-3xl p-8 text-white shadow-xl">
                   <h3 className="text-xl font-black mb-6">Voice is perfect for:</h3>
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-indigo-900 rounded-[2.5rem] p-10 md:p-14 text-center text-white shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10">
                <h2 className="text-3xl font-black mb-6 tracking-tight">Want a simple routine?</h2>
                <p className="text-xl text-indigo-100 font-bold mb-10 leading-relaxed max-w-xl mx-auto italic">
                   Try this weekly: 10 minutes voice → 3 exam questions → 5-bullet feedback → 3 drills.
                </p>
                <Link href="/quiz">
