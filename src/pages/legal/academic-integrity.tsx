        ...
        <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our commitment to ethical AI use and supporting genuine learning
              at Durham Law.
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    We encourage you to disclose AI assistance where required by
                    your institution. Our tools are meant to supplement, not
                    replace, your legal education.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Durmah, our AI assistant, is trained to guide you through
                    legal reasoning rather than provide ready-made answers for
                    submission.
                  </p>
                </div>
              </div>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6 sm:p-8 mb-8">
            ...
            <p className="text-amber-800 mb-4">
              Submitting AI-generated content as your own work may constitute
              academic misconduct under Durham University's regulations. Always:
            </p>
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-8">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              For the official Durham University academic integrity policies,
              please refer to:
            </p>
            <a
