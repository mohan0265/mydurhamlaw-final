...
export default function RedeemPage() {
    ...
    const [redeemState, setRedeemState] = useState<'verifying' | 'success' | 'error'>('verifying');
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center">
                    ...
                    <h2 className="text-xl font-bold text-gray-900">Verifying your invite...</h2>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
             <Head><title>Redeem Invite | MyDurhamLaw</title></Head>
             ...
             <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
                 {redeemState === 'success' ? (
                     ...
                     <div>
                         ...
                         <Link href="/dashboard" className="inline-flex items-center justify-center w-full py-3 px-6 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl transition-all">
                             Go to Dashboard
                         </Link>
                     </div>
                 )}
