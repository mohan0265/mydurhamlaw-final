...
const MovementPillars = () => {
  return (
    <>
      <Head>
        <title>Movement Pillars - Caseway</title>
        <meta
          name="description"
          content="The core principles and values that drive the Caseway movement in transforming legal education"
        />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-purple-100 mb-8 max-w-4xl mx-auto">
                The Fundamental Principles Driving the Future of Legal Education
                at Durham
              </p>
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Caseway is more than a platform-it's a movement to revolutionize
              legal education. Our pillars represent the core values and
              principles that guide every decision, every feature, and every
              interaction. Together, they form the foundation of a new era in
              legal education that puts students first.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-8 border border-blue-200">
                ...
                <p className="text-gray-700 mb-4">
                  Technology should enhance human potential, not replace human
                  connection. Every feature we build prioritizes the student
                  experience and maintains the warmth of human interaction.
                </p>
                <div className="bg-blue-600/10 rounded-lg p-4">
                  <p className="text-blue-800 font-medium italic">
                    "We believe AI should feel like a wise friend, not a cold
                    machine."
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-8 border border-green-200">
                ...
                <p className="text-gray-700 mb-4">
                  Legal education should be accessible to all, regardless of
                  background, financial situation, or learning style. We create
                  opportunities, not barriers.
                </p>
                <div className="bg-green-600/10 rounded-lg p-4">
                  <p className="text-green-800 font-medium italic">
                    "Excellence is achieved when everyone has the opportunity to
                    succeed."
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-pink-50 to-rose-100 rounded-xl p-8 border border-pink-200">
                ...
                <p className="text-gray-700 mb-4">
                  Academic success means nothing without mental and emotional
                  health. We integrate wellbeing support into every aspect of
                  the learning journey, making it as important as academic
                  achievement.
                </p>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl p-8 border border-purple-200">
                ...
                <p className="text-gray-700 mb-4">
                  Every student learns differently. Our AI adapts to individual
                  learning styles, pace, and preferences, creating a truly
                  personalized educational experience that evolves with each
                  student.
                </p>
                <div className="bg-purple-600/10 rounded-lg p-4">
                  <p className="text-purple-800 font-medium italic">
                    "One size fits none. Personalization is the key to unlocking
                    potential."
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-xl p-8 border border-orange-200">
                ...
                <p className="text-gray-700 mb-4">
                  We innovate responsibly, with built-in ethical guardrails and
                  academic integrity at the core. Our technology enhances
                  learning while teaching the importance of ethical practice in
                  law.
                </p>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-xl p-8 border border-teal-200">
                ...
                <p className="text-gray-700 mb-4">
                  Learning is enhanced through connection. We foster communities
                  where students support each other, share knowledge, and build
                  lasting professional relationships that extend beyond
                  graduation.
                </p>
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-blue-100 rounded-xl p-8 border border-indigo-200">
                ...
                <p className="text-gray-700 mb-4">
                  The legal landscape evolves rapidly, and so must legal
                  education. We continuously adapt our platform based on student
                  feedback, industry changes, and educational research.
                </p>
                <div className="bg-indigo-600/10 rounded-lg p-4">
                  <p className="text-indigo-800 font-medium italic">
                    "Standing still is moving backward in a world of constant
                    change."
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-pink-100 rounded-xl p-8 border border-red-200">
                ...
                <div className="bg-red-600/10 rounded-lg p-4">
                  <p className="text-red-800 font-medium italic">
                    "True education transforms not just the student, but
                    society."
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  If it doesn't align with our values, it doesn't make it into
                  the platform.
                </p>
                <ul className="text-gray-600 space-y-2 text-sm">
                  <li>
                    • User experience review against human-centered design
                  </li>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  Our pillars guide how we interact with students, faculty, and
                  the broader legal education community.
                </p>
                <ul className="text-gray-600 space-y-2 text-sm">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  Our CSR initiatives directly reflect our commitment to the
                  movement pillars, especially inclusive excellence and
                  real-world impact.
                </p>
                <ul className="text-gray-600 space-y-2 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-purple-50 to-pink-100 rounded-xl p-8">
                <p className="text-gray-700 italic mb-4 text-lg">
                  "I can feel that this platform was built with genuine care for
                  students. The way it adapts to my learning style and checks in
                  on my wellbeing shows that the developers truly understand
                  what we need."
                </p>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-8">
                <p className="text-gray-700 italic mb-4 text-lg">
                  "The pillars aren't just words on a page-you can see them in
                  action every day. When I struggled with anxiety, the platform
                  noticed and connected me with support resources immediately."
                </p>
        ...
        <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-700">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-purple-100 mb-8">
              Be part of a community that's revolutionizing legal education
              through values-driven innovation.
            </p>
