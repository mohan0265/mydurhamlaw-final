...
export default function SettingsPage() {
  ...
  useEffect(() => {
    if (userProfile && session?.user) {
      setProfile({
        ...
        durmah_voice:
          userProfile.durmah_voice || userProfile.tts_voice || "nova", // Handle legacy field
        ...
        feedback_reminder_opt_in:
          userProfile.feedback_reminder_opt_in !== false,
        // Always With You settings
  ...
  const userTypeInfo = USER_TYPE_LABELS[
    profile.user_type as keyof typeof USER_TYPE_LABELS
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Personalize your Caseway experience
              </p>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`px-3 py-1 rounded-full text-sm font-medium ${userTypeInfo.color}`}
                      >
                        {userTypeInfo.name}
                      </span>
                      <div className="group relative">
                        ...
                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                          This cannot be changed. It is fixed based on your
                ...
                <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg border border-purple-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Allow Durmah to speak responses aloud
                    </p>
                  </div>
                  <button
                    onClick={() =>
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {VOICE_OPTIONS.map((voice) => (
                      <div
                        ...
                        onClick={() =>
                          handleInputChange("durmah_voice", voice.id)
                        }
                      >
                  ...
                  <div className="flex gap-3">
                    {VOICE_SPEEDS.map((speed) => (
                      <button
                        key={speed.id}
                        onClick={() =>
                          handleInputChange("voice_speed", speed.id)
                        }
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {AI_SAFETY_LEVELS.map((level) => (
                      <div
                        ...
                        onClick={() =>
                          handleInputChange("ai_safety_level", level.id)
                        }
                      >
                ...
                <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Get reminded to rate AI responses for quality improvement
                    </p>
                  </div>
                  <button
                    onClick={() =>
                      handleInputChange(
                        "feedback_reminder_opt_in",
                        !profile.feedback_reminder_opt_in,
                      )
                    }
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      profile.feedback_reminder_opt_in
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  journey. Set up secure access for up to 2 family members or
                  close friends.
                </p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-pink-700 mt-1">
                        ...
                        shared. Your loved ones can only see what you explicitly
                        choose to share.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("parent1_email", e.target.value)
                        }
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("parent2_email", e.target.value)
                        }
                    ...
                    <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Allow loved ones to see when you&apos;re online and
                      ...
                      <button
                        onClick={() =>
                          handleSharingSettingsChange(
                            "show_live_status_to_parents",
                            !profile.sharing_settings
                              .show_live_status_to_parents,
                          )
                        }
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      ...
                      <div className="p-3 bg-blue-25 border border-blue-100 rounded-lg">
                        <div className="flex items-start space-x-2">
                          ...
                          <p className="text-xs text-blue-700">
                            <strong>Privacy Mode:</strong> You&apos;ll stay
                            logged in but appear offline to loved ones. However,
                            you&apos;ll still see when they&apos;re online and
                            can receive video calls from them.
                          </p>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Share your daily lectures, seminars, and study
                          sessions
                        </p>
                      </div>
                    </div>
                    <button
                      onClick={() =>
                        handleSharingSettingsChange(
                          ...
                          !profile.sharing_settings.share_today_calendar,
                        )
                      }
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        profile.sharing_settings.share_today_calendar
                  ...
                  <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Share notes about your studies, mood, and plans
                        </p>
                      </div>
                    </div>
                    <button
                      onClick={() =>
                        handleSharingSettingsChange(
                          "share_custom_notes",
                          !profile.sharing_settings.share_custom_notes,
                        )
                      }
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        profile.sharing_settings.share_custom_notes
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-100 rounded-lg border border-gray-200">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Temporarily hide from loved ones and disable video
                          calls
                        </p>
                      </div>
                    </div>
                    <button
                      onClick={() =>
                        handleSharingSettingsChange(
                          "do_not_disturb",
                          !profile.sharing_settings.do_not_disturb,
                        )
                      }
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        profile.sharing_settings.do_not_disturb
                  ...
                  <div className="p-4 bg-amber-50 rounded-lg border border-amber-200">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Set hours when video calls are automatically disabled
                      (you&apos;ll still appear online to loved ones)
                    </p>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-sm text-gray-700">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <p>
                      Access your dashboard based on your sharing preferences
                    </p>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-sm text-blue-800">
                    <strong>Security:</strong> Only the email addresses you add
                    here can access your information. You can remove access at
                    any time by clearing the email fields.
                  </p>
                </div>
              </CardContent>
            </Card>
