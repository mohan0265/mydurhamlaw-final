          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border rounded-lg px-3 py-2 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500/50"
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 px-3 text-xs text-pink-600 hover:text-pink-800"
