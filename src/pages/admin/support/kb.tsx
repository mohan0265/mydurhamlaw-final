...
export default function AdminKB() {
  ...
  const togglePublished = (k: KB) =>
    saveArticle({ ...k, is_published: !k.is_published });
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <input
                  ...
                  onChange={(e) =>
                    setArticles((prev) =>
                      prev.map((p) =>
                        p.slug === a.slug ? { ...p, title: e.target.value } : p,
                      ),
                    )
                  }
              ...
              <div className="text-xs text-slate-500 mb-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setArticles((prev) =>
                      prev.map((p) =>
                        p.slug === a.slug ? { ...p, slug: e.target.value } : p,
                      ),
                    )
                  }
              ...
              <textarea
                ...
                onChange={(e) =>
                  setArticles((prev) =>
                    prev.map((p) =>
                      p.slug === a.slug ? { ...p, body: e.target.value } : p,
                    ),
                  )
                }
