...
const Year3Dashboard = () => {
  ...
  const yearKey = activeYear === 'foundation' ? 'foundation_year' :
                  ...
                  activeYear === 'year3' ? 'year_3' : 'year_3';
  ...
  const getYearDisplayName = (year: string | null) => {
    ...
    return names[year || 'year3'] || 'Year 3';
  };
  ...
  return (
      <DashboardLayout>
        ...
        <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mt-6" role="alert">
          <p className="font-bold">{getYearDisplayName(activeYear)} - Final Year</p>
          <p>
            ...
            {activeYear === 'year3' && "Focus on your dissertation and career preparation. You're almost there!"}
          </p>
        </div>
