...
export default function WriteLawPage() {
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>Write Law - Structured Legal Writing & Integrity | MyDurhamLaw</title>
        <meta name="description" content="Master structured legal writing, IRAC methodology, and academic integrity with MyDurhamLaw." />
      </Head>
      ...
      <div className="py-20 lg:py-32 bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
               Legal writing is not just about grammar—it's about structure. 
               Learn to build arguments that survive scrutiny.
            </p>
      ...
      <div className="py-24 max-w-5xl mx-auto px-6">
         <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 border border-gray-100 rounded-2xl bg-white shadow-sm">
               ...
               <h3 className="text-2xl font-bold text-gray-900 mb-4">Academic Integrity First</h3>
               <p className="text-gray-600 leading-relaxed mb-6">
                  We don't write essays for you. We teach you how to plan, structure, and cite your own work 
                  to the highest Durham standards.
               </p>
               <Link href="/learn/durham-law-academic-integrity-ai" className="text-orange-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
            ...
            <div className="p-8 border border-gray-100 rounded-2xl bg-white shadow-sm">
               ...
               <p className="text-gray-600 leading-relaxed mb-6">
                  Break down complex assignment briefs into manageable research tasks and logical steps.
               </p>
               <Link href="/signup" className="text-purple-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
