            ...
            {loginMode === 'choose' && (
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 space-y-4">
                ...
                <ul className="text-sm text-blue-800 space-y-2 list-disc list-inside">
                  <li>Sign in with the <strong>exact email</strong> your student added.</li>
                  <li>If admin created your account, use <strong>email and password</strong>.</li>
                ...
                <div className="text-xs text-blue-600 pt-2 border-t border-blue-200">
                  Tip: Ask your student or admin for your login credentials if you can&apos;t access the dashboard.
                </div>
              </div>
            )}
          </div>
