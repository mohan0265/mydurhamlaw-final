...
export default function QuizHub() {
  ...
  const seo = generateSEOTags({
    ...
    description: 'The central engine for Durham Law students to practice speaking and thinking law.',
    canonical: '/quiz'
  });
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-xl leading-relaxed">
              Practise articulation, test your reasoning, and get professor-level feedback grounded in your Durham syllabus.
            </p>
            <button 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            {!showSetup && sessions.length === 0 && !loading && (
              <div className="bg-white rounded-[2.5rem] border border-gray-100 p-12 text-center shadow-sm">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-3">Your first tutorial awaits</h2>
                <p className="text-gray-500 mb-8 max-w-md mx-auto">
                  Select a lecture or a module, and Durmah will challenge your legal reasoning with grounded scenarios.
                </p>
              </div>
            )}
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 bg-purple-50 rounded-2xl flex items-center justify-center shrink-0">
                          {session.quiz_type === 'lecture' ? <Play className="w-5 h-5 text-purple-600" /> : <Brain className="w-5 h-5 text-purple-600" />}
                        </div>
                        <div>
                          <h3 className="font-bold text-gray-900 mb-1 group-hover:text-purple-600 transition-colors">
                            {session.quiz_type === 'lecture' ? 'Lecture Quiz' : 'Module Mastery'}
                          </h3>
                          <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest">
                            {session.module_code} {session.target_title ? `• ${session.target_title}` : ''}
                          </p>
                        </div>
                      </div>
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden">
               <div className="relative z-10">
                 ...
                 <p className="text-indigo-100/80 text-sm leading-relaxed mb-6">
                   Durmah only quizzes you on concepts explicitly found in your Durham syllabus and lecture transcripts. Zero hallucinations.
                 </p>
            ...
            <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-sm">
               ...
               <p className="text-gray-500 text-xs mb-6 leading-relaxed uppercase tracking-widest font-black">Pro Feature</p>
               <p className="text-sm text-gray-600 mb-6 font-medium">
                 Enable real-time voice debates. Practise articulating arguments under pressure for your next seminar.
               </p>
