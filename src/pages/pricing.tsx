  ...
  const features = [
    {
      ...
      description:
        "Get personalized help with legal concepts, case analysis, and essay writing",
    ...
    },
    {
      ...
      description:
        "Stay connected with family and friends through our unique presence system",
    ...
    },
    {
      ...
      description:
        "Natural language conversations with context-aware responses",
    ...
    },
    {
      ...
      description:
        "Built-in safeguards to maintain academic honesty and transparency",
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-white pt-16 pb-20 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-500 text-xs font-bold uppercase tracking-widest mb-8">
              Independent study companion • Not affiliated with Durham
              University
            </p>
            ...
            <p className="text-lg text-gray-500 mb-10 max-w-2xl mx-auto">
              Study smarter with voice + text support, year planning (YAAG),
              deadlines, assignments and exam practice — built for Durham Law
              students.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm flex flex-col">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed text-sm flex-1">
                  <p>
                    We treat all students equally — Full Access unlocks the same
                    features for everyone.
                  </p>
                  <p>
                    To keep the service fast, stable, and affordable, we apply
                    fair-use on high-cost resources like realtime voice. Normal
                    study use is always fine.
                  </p>
                  <p className="bg-indigo-50 p-4 rounded-xl border border-indigo-100 font-medium italic">
                    If someone uses voice for hours every day (like a
                    call-centre), we’ll gently prompt them to add Voice Boost so
                    performance stays great for everyone.
                  </p>
                </div>
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <Link
                    href="/legal/voice-efficiency-tips"
                    className="text-indigo-600 font-bold text-sm hover:underline flex items-center gap-1"
                  >
                    See Voice Boost options & efficiency tips{" "}
              ...
              <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm flex flex-col">
                ...
                <p className="text-[10px] font-black text-green-600 uppercase tracking-widest mb-4">
                  Experience the Real Workflow
                </p>
                <div className="space-y-4 text-gray-600 leading-relaxed text-sm flex-1">
                  <p>
                    Your 14-day trial includes <strong>Full Access</strong> so
                    you can experience the real Durham study workflow.
                  </p>
                  <p>
                    Voice and uploads are generous during trial, with fair-use
                    protections to prevent abuse and keep the platform smooth
                    for everyone.
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-gray-600">
                A platform built on honesty. No fake reviews, just real student
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600">
                  After your 14-day free trial, you can choose to upgrade to a
                  paid plan or continue with limited features. You'll never be
                  charged without your explicit consent.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  protect your data and comply with all relevant privacy
              ...
              <div>
                ...
                <p className="text-gray-600">
                  AWY is our unique presence system that lets you stay connected
                  with family and friends. They can see when you're online and
                  studying, and you can share quick updates about your day.
                </p>
              </div>
            </div>
          </div>
