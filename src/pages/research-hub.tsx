              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Get instant help with legal research, case summaries, and
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      const searchInput = document.querySelector(
                        'textarea[placeholder*="legal query"]',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card hover>
              ...
              <CardContent className="space-y-3">
                {[
                  {
                    name: "Law Trove - Oxford Textbooks",
            ...
            <CardContent className="py-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Explore our comprehensive collection of legal databases, case
                  law repositories, and study materials.
                </p>
                <Link
                  href="/references"
