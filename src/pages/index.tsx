  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="AI for law students: memory, planning, case law, wellbeing" />
      </Head>
          ...
          <div className="animate-fadeIn">
            ...
            <div className="mb-4 sm:mb-6 animate-slideUp" style={{ animationDelay: '0.2s' }}>
              <p className="text-lg sm:text-2xl lg:text-3xl font-medium text-pink-200 leading-relaxed">
                ...
                Built with heart, exclusively for Durham University Law Foundation and Undergraduate Students.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 max-w-5xl mx-auto">
                ...
                <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-white border-opacity-20 hover:bg-opacity-15 transition-all duration-300 min-h-[80px] flex items-center">
                  <div className="flex items-start space-x-2 sm:space-x-3 w-full">
                    ...
                    <div className="text-left flex-1">
                      <h3 className="font-semibold text-white mb-1 text-sm sm:text-base">AI-Powered Academic Support</h3>
                      <p className="text-xs sm:text-sm text-gray-300">Tailored to your year with intelligent study guidance</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-white border-opacity-20 hover:bg-opacity-15 transition-all duration-300 min-h-[80px] flex items-center">
                  <div className="flex items-start space-x-2 sm:space-x-3 w-full">
                    ...
                    <div className="text-left flex-1">
                      <h3 className="font-semibold text-white mb-1 text-sm sm:text-base">Voice Mode with Memory</h3>
                      <p className="text-xs sm:text-sm text-gray-300">Like a human study companion who remembers you</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-white border-opacity-20 hover:bg-opacity-15 transition-all duration-300 min-h-[80px] flex items-center">
                  <div className="flex items-start space-x-2 sm:space-x-3 w-full">
                    ...
                    <div className="text-left flex-1">
                      <h3 className="font-semibold text-white mb-1 text-sm sm:text-base">Legal Assignment Drafting</h3>
                      <p className="text-xs sm:text-sm text-gray-300">Guidance with built-in ethics guardrails</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-white border-opacity-20 hover:bg-opacity-15 transition-all duration-300 min-h-[80px] flex items-center">
                  <div className="flex items-start space-x-2 sm:space-x-3 w-full">
                    ...
                    <div className="text-left flex-1">
                      <h3 className="font-semibold text-white mb-1 text-sm sm:text-base">Mental Wellness Support</h3>
                      <p className="text-xs sm:text-sm text-gray-300">Journaling and reflection assistant</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-white border-opacity-20 hover:bg-opacity-15 transition-all duration-300 min-h-[80px] flex items-center">
                  <div className="flex items-start space-x-2 sm:space-x-3 w-full">
                    ...
                    <div className="text-left flex-1">
                      <h3 className="font-semibold text-white mb-1 text-sm sm:text-base">Case Law References</h3>
                      <p className="text-xs sm:text-sm text-gray-300">Comprehensive legal research in one place</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-white border-opacity-20 hover:bg-opacity-15 transition-all duration-300 min-h-[80px] flex items-center">
                  <div className="flex items-start space-x-2 sm:space-x-3 w-full">
                    ...
                    <div className="text-left flex-1">
                      <h3 className="font-semibold text-white mb-1 text-sm sm:text-base">Timetables & Deadlines</h3>
                      <p className="text-xs sm:text-sm text-gray-300">All your academic schedule in one place</p>
                    </div>
                  </div>
                </div>
            ...
            {/* Call to Action */}
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-6 animate-slideUp" style={{ animationDelay: '0.8s' }}>
              {/* Primary CTA */}
              <Link href="/signup">
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-br from-blue-900 to-purple-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-4xl font-bold text-white mb-3 sm:mb-4">Built for Law Students</h2>
          <p className="text-blue-200 text-base sm:text-lg mb-8 sm:mb-12">Everything you need to succeed at Durham and beyond</p>
        ...
        <section className="py-12 sm:py-20 bg-gradient-to-br from-green-50 to-blue-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-4xl font-bold mb-3 sm:mb-4 text-gray-900">Welcome Back, {user.email?.split('@')[0]?.replace(/[0-9]/g, '')}!</h2>
              <p className="text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base">Quick access to your most used features</p>
            </div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-12">
              <Link href="/LoginRedirectPage" className="group">
                <div className="bg-white rounded-2xl shadow-lg p-3 sm:p-6 border border-blue-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 min-h-[120px] sm:min-h-[140px]">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-xl sm:text-2xl mb-2 sm:mb-4 mx-auto">📊</div>
                  <h3 className="text-sm sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 text-center">Dashboard</h3>
                  <p className="text-xs sm:text-sm text-gray-600 text-center">Your study overview and progress</p>
                </div>
              </Link>
              <Link href="/wellbeing" className="group">
                <div className="bg-white rounded-2xl shadow-lg p-3 sm:p-6 border border-pink-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 min-h-[120px] sm:min-h-[140px]">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center text-white text-xl sm:text-2xl mb-2 sm:mb-4 mx-auto">💬</div>
                  <h3 className="text-sm sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 text-center">Durmah</h3>
                  <p className="text-xs sm:text-sm text-gray-600 text-center">Your personal wellbeing companion</p>
                </div>
              </Link>
              <Link href="/study-schedule" className="group">
                <div className="bg-white rounded-2xl shadow-lg p-3 sm:p-6 border border-green-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 min-h-[120px] sm:min-h-[140px]">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center text-white text-xl sm:text-2xl mb-2 sm:mb-4 mx-auto">📅</div>
                  <h3 className="text-sm sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 text-center">Study Schedule</h3>
                  <p className="text-xs sm:text-sm text-gray-600 text-center">Timetable and calendar management</p>
                </div>
              </Link>
              <Link href="/assignments" className="group">
                <div className="bg-white rounded-2xl shadow-lg p-3 sm:p-6 border border-orange-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 min-h-[120px] sm:min-h-[140px]">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center text-white text-xl sm:text-2xl mb-2 sm:mb-4 mx-auto">📝</div>
                  <h3 className="text-sm sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 text-center">Assignments</h3>
                  <p className="text-xs sm:text-sm text-gray-600 text-center">Writing and Research Buddy</p>
                </div>
              </Link>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 mb-8 sm:mb-12 text-sm sm:text-base">See how AI elevates your study game</p>
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-br from-gray-900 to-blue-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-4xl font-bold text-white mb-3 sm:mb-4">What Students & Parents Say</h2>
          <p className="text-blue-200 mb-8 sm:mb-12 text-sm sm:text-base">Real impact, real feedback</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
            <TestimonialCard quote="I looked through the App. I wish I had such an App to support me during my undergrad years." author="SK Soon" role="2020 Batch Durham Law Graduate" />
            <TestimonialCard quote="I saw the preview of the App and it looks impressive. I am waiting for it to launch officially soon. I think it will help my daughter who is going to start her Foundation Year at Durham." author="Mark D." role="Parent of a 2025 Foundation Student" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-center">
        <div className="px-4 sm:px-6">
          <h2 className="text-2xl sm:text-4xl font-bold text-white mb-3 sm:mb-4">A Personalised Study Experience</h2>
          <p className="text-lg sm:text-xl text-blue-100 mb-6 sm:mb-8">Join thousands of Durham law students already using MyDurhamLaw</p>
          <Link href="/signup">
