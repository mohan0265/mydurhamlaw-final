...
export default function StayCurrentPage() {
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>Stay Current - Legal News & Commercial Awareness | MyDurhamLaw</title>
        <meta name="description" content="Build commercial awareness with our live legal news feed, tailored for Durham Law students." />
      </Head>
      ...
      <div className="py-20 lg:py-32 bg-gray-950 text-white overflow-hidden relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
               Law does not happen in a vacuum. Connect your studies to the real world 
               with our live legal news feed.
            </p>
      ...
      <div className="py-24 max-w-4xl mx-auto px-6">
         <div className="grid sm:grid-cols-2 gap-12">
            <div>
               <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Commercial Awareness Matters</h3>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
               <h3 className="text-xl font-bold text-gray-900 mb-4">Latest Headlines</h3>
               <p className="text-gray-600 mb-6 text-sm">
                  Our feed aggregates top legal news sources, filtered for relevance to UK law students.
               </p>
               <Link href="/legal/tools/legal-news-feed" className="text-red-600 font-bold text-sm hover:underline">
                  View Full Feed &rarr;
               </Link>
            </div>
         </div>
