      ...
      resources: [
        {
          ...
          description:
            "Free access to UK and Irish case law, legislation, and legal materials",
        ...
        },
        {
          name: "Westlaw UK",
          description:
            "Comprehensive legal database with case law, legislation, and commentary",
      ...
      resources: [
        {
          name: "Lexis+ UK",
          description:
            "Extensive collection of case law, legislation, and legal analysis",
        ...
        },
        {
          name: "HeinOnline",
          description:
            "Legal journals, historical documents, and government publications",
      ...
      resources: [
        {
          ...
          description:
            "Official source for UK primary and secondary legislation",
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Trusted resources for UK law research and study
                    </p>
                  </div>
                </div>
                <p className="text-gray-600 max-w-3xl">
                  Access curated legal databases, case law repositories, and
                  research tools specifically chosen for Durham Law students and
                  UK legal education.
                </p>
              </div>
            </CardContent>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Get instant help with legal concepts, case summaries, and
                    research guidance
                  </p>
                </div>
              </div>
              ...
              <Card key={categoryIndex} hover>
                ...
                <CardContent className="space-y-4">
                  {category.resources.map((resource, resourceIndex) => (
                    <div
                      key={resourceIndex}
                      className="group border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:bg-blue-50/50 transition-all duration-200"
                    >
            ...
            <Card hover>
              ...
              <CardContent className="space-y-4">
                {academicResources.map((resource, index) => (
                  <div
                    key={index}
                    className="border border-gray-200 rounded-lg p-4 hover:border-amber-300 hover:bg-amber-50/50 transition-all duration-200"
                  >
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <Badge
                        variant={
                          resource.badge === "Durham" ? "info" : "default"
                        }
                      >
                        {resource.badge}
                      </Badge>
            ...
            <Card hover>
              ...
              <CardContent className="space-y-4">
                {professionalResources.map((resource, index) => (
                  <div
                    key={index}
                    className="border border-gray-200 rounded-lg p-4 hover:border-indigo-300 hover:bg-indigo-50/50 transition-all duration-200"
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h4 className="font-semibold text-gray-800">
                        {resource.name}
                      ...
                      <Badge
                        variant={
                          resource.badge === "Official" ? "info" : "purple"
                        }
                      >
                        {resource.badge}
                      </Badge>
        ...
        <footer className="border-t border-white/20 backdrop-blur-sm bg-white/50 py-8 text-center">
          <div className="max-w-7xl mx-auto px-6">
            <p className="text-sm text-gray-500">
              &copy; 2024 Caseway AI Study Assistant. Built with ❤️ for legal
              excellence.
            </p>
