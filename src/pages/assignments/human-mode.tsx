...
const HumanModePage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Human Mode Drafting™ - MyDurhamLaw</title>
        <meta name="description" content="Academic integrity-compliant AI assistance for legal studies" />
      </Head>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-gray-900">Human Mode Drafting™</h1>
                    <p className="text-gray-600">Academic integrity-first AI assistance</p>
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-gray-900">Academic Integrity First</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                        <span className="text-sm font-medium text-gray-900">Cite-Ready Coaching</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
                        <span className="text-sm font-medium text-gray-900">Coach-Not-Ghost</span>
                      </div>
                    </div>
              ...
              <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Our Commitment to Academic Integrity</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-700">
                  <div>
                    <strong className="text-gray-900">Never Ghost-Write:</strong> We provide guidance, outlines, and explanations - never submission-ready content.
                  </div>
                  <div>
                    <strong className="text-gray-900">Always Cite:</strong> We help you identify sources and format OSCOLA citations correctly.
                  </div>
                  <div>
                    <strong className="text-gray-900">Build Independence:</strong> Our goal is to develop your analytical skills, not replace your thinking.
                  </div>
                </div>
                <div className="mt-4 pt-4 border-t border-gray-200 text-xs text-gray-500">
                  <p>
                    All AI interactions are logged for transparency. 
                    <Link href="/ethics" className="text-blue-600 hover:underline ml-1">
