                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600">
                      AI-powered assignment writing with your personal style
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-8">
            <Card hover className="text-center">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  AI learns your unique writing style for personalized,
            ...
            <Card hover className="text-center">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  Advanced algorithms bypass AI detection tools for natural
                  writing
                </p>
              </CardContent>
            </Card>
            ...
            <CardContent className="p-4 sm:p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                <div className="text-center">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">
                    Add your past essays or writing samples to build your style
                    profile
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">
                    Advanced AI analyzes your writing patterns, vocabulary, and
                    style
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">
                    Generate content that perfectly matches your unique writing
                    voice
                  </p>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-yellow-700 leading-relaxed">
                    This tool is designed to assist with learning and
                    understanding legal concepts. Always ensure your work
                    complies with your institution&apos;s academic integrity
                    policies. Use generated content as a starting point for your
                    own analysis and research.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <footer className="border-t border-white/20 backdrop-blur-sm bg-white/50 py-4 sm:py-8 text-center">
          <div className="max-w-6xl mx-auto px-3 sm:px-6">
            <p className="text-xs sm:text-sm text-gray-500">
              &copy; 2024 Caseway AI Study Assistant. Human-Mode Drafting™ and
              Private Style Memory™ are proprietary technologies.
            </p>
            <p className="text-xs text-gray-400 mt-1 sm:mt-2">
              Powered by advanced AI and vector similarity matching for
