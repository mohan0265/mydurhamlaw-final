      ...
      try {
        ...
        if (profileData) {
          setProfile({
            ...
            year_group:
              profileData.year_group || profileData.year_of_study || "",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="max-w-5xl mx-auto p-4 sm:p-8 pt-6">
        <Head>
          <title>My Profile - Caseway</title>
        </Head>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Manage your academic details and loved ones
            </p>
          </div>
          ...
          <Card id="loved-ones">
            ...
            <CardContent className="p-6">
              <p className="text-sm text-gray-600 mb-6">
                People listed here can see your online status via the
                &quot;Always With You&quot; widget. You can revoke access at any
                time.
              </p>
              ...
              <div className="bg-pink-50/50 rounded-xl p-4 border border-pink-100 mb-8">
                <h3 className="font-semibold text-gray-800 mb-3 flex items-center gap-2">
                  <Plus className="w-4 h-4 text-pink-600" /> Invite New
                  Connection
                </h3>
