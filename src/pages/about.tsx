        ...
        <main className="p-6 space-y-8 max-w-6xl mx-auto">
          ...
          <div className="text-center space-y-6 py-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Your personal AI study companion, built with love for every Durham
              Law student. From Foundation Year to Finals - we&apos;re here to
              support your academic journey and wellbeing.
            </p>
          </div>
          ...
          <Card className="bg-gradient-to-r from-purple-50 to-indigo-50 border-purple-200 shadow-xl">
            ...
            <CardContent>
              ...
              <p className="text-gray-600">
                ...
                care for student wellbeing, creating a space where academic
                excellence and mental health go hand in hand.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-cyan-50 border-blue-200 shadow-lg">
            ...
            <CardContent className="space-y-4">
              <p className="text-lg text-gray-700">
                <strong>Durmah</strong> is your personal voice companion,
                available 24/7 to help with studies, provide emotional support,
                and offer guidance through the challenges of law school.
              </p>
              <div className="bg-blue-100 p-4 rounded-lg border-l-4 border-blue-500">
                <p className="text-sm text-blue-800 italic">
                  <strong>Etymology:</strong> The name &quot;Durmah&quot; draws
                  inspiration from the Sanskrit word &quot;Dharma&quot; -
                  meaning law, truth, and righteous living. It embodies the
                  principles of justice, balance, and ethical grounding that
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Essay help, research guidance, and study planning
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Stress management, reflection, and emotional support
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="hover:shadow-lg transition-shadow duration-200">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  AI-powered essay assistance, research tools, and assignment
                  generators tailored for law students
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Stress management tools, reflection journals, and emotional
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Natural voice conversations with Durmah for instant support
                  and guidance
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Transparent, responsible AI that respects academic integrity
                  and student privacy
                </p>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-sm text-gray-600">
                    Building strong foundations in legal thinking and academic
                    skills
                  </p>
                </div>
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Tools designed around Durham&apos;s specific curriculum,
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Reflecting Durham&apos;s tradition of supporting the whole
                    student, not just academic achievement
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-gradient-to-r from-rose-50 to-pink-50 border-rose-200 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl text-rose-800 flex items-center gap-3">
                <Heart className="w-7 h-7 text-rose-600" />A Gift That Became a
                Movement
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Our AI helps you learn and understand, never replacing your
                    own thinking and analysis
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Your conversations and data are protected with the highest
                    security standards
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    We&apos;re open about how our AI works and committed to
