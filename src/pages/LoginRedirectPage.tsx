      ...
      try {
        ...
        if (user.user_metadata?.role === "loved_one") {
          ...
          if (connectionData) {
            ...
            userRole = "loved_one";
            console.log(
              "🔍 User role from awy_connections (email match): loved_one",
            );
          }
        }
        ...
        if (userRole === "loved_one" && user.email) {
          try {
            ...
            try {
              ...
              console.log(
                "💓 Loved one heartbeat sent - now visible to student",
              );
            } catch (hbErr: any) {
            ...
            console.warn(
              "Failed to link loved one connection:",
        ...
        if (existingProfile) {
          ...
          const baseProfileData: any = {
            ...
            agreed_to_terms:
              userRole === "loved_one"
                ? true
                : (signupMetadata as any)?.agreed_to_terms || false,
          ...
          if (userRole === "loved_one") {
            ...
            if (selectedPlan && selectedPlan !== "free") {
              ...
              console.log(
                `[auth/callback] Initiating checkout for plan: ${selectedPlan}`,
              );
        ...
        {showFallback && (
          <div className="mt-8 p-6 bg-white rounded-lg shadow-lg">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => safeReplace(router, "/onboarding")}
