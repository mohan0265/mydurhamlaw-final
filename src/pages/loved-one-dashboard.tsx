...
export default function LovedOneDashboard() {
      ...
      if (error) {
        ...
        if (
          ...
          (msg.includes("function") &&
            (msg.includes("not found") || msg.includes("could not find")))
        ) {
  ...
  useEffect(() => {
    ...
    const heartbeatInterval = setInterval(async () => {
      if (!user) return;
      await supabase.rpc("awy_heartbeat", {
        p_is_available: isMyAvailabilityOnRef.current,
      });
    }, 30000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-red-50">
      <Head>
        <title>Loved One Dashboard - Caseway</title>
      </Head>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {availabilityNote
                  ...
                  : "Select your status to let your student know you're around."}
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div
                className={`w-4 h-4 rounded-full mb-2 ${availabilityStatus === "available" ? "bg-green-500" : "bg-gray-300"}`}
              />
            ...
            >
              <div
                className={`w-4 h-4 rounded-full mb-2 ${availabilityStatus === "busy" ? "bg-orange-500" : "bg-gray-300"}`}
              />
          ...
          {students.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-2xl border border-gray-200 border-dashed">
              ...
              <p className="text-sm text-gray-400 mt-2">
                Ask your student to add you via their settings.
              </p>
            </div>
          ) : (
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p
                      className={`text-sm font-medium ${student.isAvailable ? "text-green-600" : "text-gray-500"}`}
                    >
        ...
        <div className="mt-8 bg-blue-50 border border-blue-100 rounded-xl p-4 text-sm text-blue-800">
          <p>
            Use the details your student provided (WhatsApp, FaceTime) to
            contact them when they are available.
          </p>
        </div>
      </main>
    </div>
