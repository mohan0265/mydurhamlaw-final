...
export default function LnatSignupPage() {
    ...
    async function handleLnatOnboarding() {
      if (user) {
        ...
        try {
          ...
          const res = await fetch("/api/entitlements/ensure-lnat", {
            method: "POST",
          });
      ...
      options: {
        redirectTo:
          typeof window !== "undefined"
            ? `${window.location.origin}/lnat/signup`
            : undefined,
      },
    });
    if (error) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center animate-pulse">
          ...
          <h2 className="text-xl font-bold text-gray-900">
            Setting up your LNAT workspace...
          </h2>
        </div>
      </div>
    );
  ...
  return (
    <>
      <Head>
        <title>
          {isLaunchEnabled ? "LNAT Mentor - Sign Up" : "LNAT Mentor (Upcoming)"}
        </title>
      </Head>
            ...
            {!isLaunchEnabled && !joinedWaitlist && (
              ...
              >
                <div className="p-4 bg-purple-50 rounded-xl text-sm text-purple-800 border border-purple-100 mb-4">
                  LNAT Mentor is currently in development. Leave your details
                  and we’ll notify you as soon as early access opens.
                </div>
                ...
                <div>
                  ...
                  <input
                    required
                    type="text"
                    className="w-full rounded-lg border-gray-300 focus:ring-purple-500 focus:border-purple-500 text-gray-900"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setWaitlistForm({ ...waitlistForm, role: e.target.value })
                    }
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setWaitlistForm({ ...waitlistForm, year: e.target.value })
                    }
                  />
                </div>
            ...
            {isLaunchEnabled && (
              <>
                ...
                <div className="mt-6 text-center text-xs text-gray-400">
                  By continuing, you agree to our Terms. <br /> This account is
                  for LNAT preparation only.
                </div>
              </>
            )}
          </div>
