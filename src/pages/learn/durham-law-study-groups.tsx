...
const seo = generateArticleSEO({
  ...
  description:
    "Build effective, compliant study groups for Durham Law. Learn optimal size, meeting structure, and ethical AI use for collaborative learning.",
  slug: "durham-law-study-groups",
  keywords:
    "law school study groups, Durham Law collaboration, peer learning, legal education, exam prep groups, academic integrity",
});
...
const faqs = [
  {
    ...
    answer:
      'Start with your college. Post on your year group\'s WhatsApp or Facebook page: "Looking for 2-3 students for a weekly Contract Law study group." Alternatively, ask in tutorials - someone nearby is likely interested.',
  },
  {
    question: "How long should study group meetings last?",
    answer:
      "90-120 minutes. Shorter than 90 mins limits depth; longer than 2 hours causes fatigue and diminishing returns.",
  },
  {
    question: "Can we use AI during study group meetings?",
    answer:
      "Yes, for research, clarification, and exploration. But do not use AI to generate answers you then all submit individually - that is still plagiarism.",
  },
];
    ...
    <>
      ...
      >
        <article className="prose prose-lg max-w-none">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg text-gray-600 mb-4">
                  Build effective, integrity-compliant study groups with optimal
                  structure and ethical AI use
                </p>
          ...
          <p>Legal education rewards collaborative reasoning:</p>

          <ul>
            <li>
              <strong>Diverse perspectives</strong>: Your peer sees a case from
              a different angle
            </li>
            <li>
              <strong>Accountability</strong>: Weekly meetings keep you on track
            </li>
            <li>
              <strong>Active recall</strong>: Explaining a concept to others
              cements your understanding
            </li>
            <li>
              <strong>Exam simulation</strong>: Group problem-solving mirrors
              tutorial and exam conditions
            </li>
          </ul>

          <p>
            <strong>Research finding</strong>: Students in structured study
            groups score 10-15% higher on average than solo learners.
          </p>

          {/* Framework */}
          <h2 id="framework">The Study Group Framework</h2>

          <h3>Step 1: Form a Group (3-5 Students Ideal)</h3>
          <p>
            <strong>Why 3-5?</strong>
          </p>
          <ul>
            <li>
              <strong>Too small</strong> (2): One person dominates or it is just
              social
            </li>
            <li>
              <strong>Too large</strong> (6+): Coordination becomes difficult;
              quieter members disengage
            </li>
          </ul>
          ...
          <ol>
            <li>
              <strong>Same college</strong>: Easy meeting logistics
            </li>
            <li>
              <strong>Same modules</strong>: Shared syllabus focus
            </li>
            <li>
              <strong>Mixed ability</strong>: Stronger students reinforce by
              teaching; weaker students ask clarifying questions
            </li>
          </ol>
          ...
          <div className="not-prose my-4 p-4 bg-gray-100 rounded-lg border border-gray-200 font-mono text-sm">
            <p>
              <strong>Durham Law Study Group Charter</strong>
            </p>
          ...
          <p>
            <strong>Pre-Meeting (Individual Work)</strong>:
          </p>
          <ul>
          ...
          <ul>
            <li>
              <strong>00:00 - 00:15</strong>: Quick wins - Clarify facts of
              upcoming cases
            </li>
            <li>
              <strong>00:15 - 01:00</strong>: Deep dive - Rotating leader
              presents a complex topic
            </li>
            <li>
              <strong>01:00 - 01:30</strong>: Problem question practice - Work
              through past exam question
            </li>
            <li>
              <strong>01:30 - 01:50</strong>: AI-assisted research - Use Durmah
              to explore unanswered questions
            </li>
            <li>
              <strong>01:50 - 02:00</strong>: Next steps - Assign next week\'s
              leader
            </li>
          </ul>
          ...
          <p>
            <strong>Why rotation works</strong>: Prevents one person from
            dominating and forces everyone to engage deeply.
          </p>
          ...
          <p>
            <strong>Symptoms</strong>: Meetings start late, drift off-topic, no
            one prepares
          </p>
          <p>
            <strong>Fix</strong>:
          ...
          <p>
            <strong>Symptoms</strong>: Same student answers every question;
            others feel redundant
          </p>
          <p>
            <strong>Fix</strong>:
          </p>
          <ul>
            <li>
              Use "round-robin" questioning: each person must contribute before
              anyone speaks twice
            </li>
            <li>
              Assign specific roles (e.g., "You explain the facts, you explain
              the ratio")
            </li>
          </ul>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-2">
                  STOP: Contract Cheating
                </h4>
                <p className="text-gray-700 text-sm">
                  "Let\'s divvy up this essay and each write one section" is
                  contract cheating and will result in academic misconduct
                  penalties.
                </p>
                <p className="text-gray-700 text-sm mt-2">
                  <strong>Allowed</strong>: Discussing essay structures,
                  comparing arguments, sharing research tips
                </p>
                <p className="text-gray-700 text-sm">
                  <strong>Prohibited</strong>: Writing each other\'s essays,
                  sharing draft paragraphs, submitting joint work as individual
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="not-prose my-8 p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-xl border border-green-200">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Optimal size</strong>: 3-5 students for balance and
                  engagement
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span>
                  <strong>Structure meetings</strong>: Pre-work, timed agenda,
                  rotating roles
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span>
                  <strong>Stay integrity-compliant</strong>: Share learning
                  strategies, not assessed work
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span>
                  <strong>Use AI wisely</strong>: Enhance group research; do not
                  replace individual thinking
                </span>
              </li>
            </ul>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              ...
              >
                <h4 className="font-semibold text-gray-900 mb-1">
                  Durham Law AI Study Assistant
                </h4>
                <p className="text-sm text-gray-600">
                  Use Durmah in group meetings for research
                </p>
              </Link>
              <Link
              ...
              >
                <h4 className="font-semibold text-gray-900 mb-1">
                  Durham Law Wellbeing Routine
                </h4>
                <p className="text-sm text-gray-600">
                  Balance collaborative study with personal wellbeing
                </p>
              </Link>
            </div>
          </div>
