...
export default function DurhamLecturesArticle() {
  ...
  const articleSchema = {
    ...
    "description": "How to effectively manage Panopto recordings, capture lecturer emphasis, and structure your notes for revision at Durham Law School.",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://mydurhamlaw.com/learn/durham-lectures"
    }
  };
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [{
      ...
      "item": "https://mydurhamlaw.com/learn/durham-lectures"
    }]
  };
  ...
  return (
    <>
      <Head>
        <title>Mastering Durham Law Lectures: Panopto, Notes & Emphasis | MyDurhamLaw</title>
        <meta name="description" content="Stop transcribing blindly. Learn the strategic workflow for Durham Law lectures: using Panopto effectively, spotting lecturer signals, and creating revision-ready notes." />
        <link rel="canonical" href="https://mydurhamlaw.com/learn/durham-lectures" />
        <meta property="og:title" content="Mastering Durham Law Lectures: Strategy & Workflow" />
        <meta property="og:description" content="Stop transcribing blindly. Learn the strategic workflow for Durham Law lectures." />
        <meta property="og:url" content="https://mydurhamlaw.com/learn/durham-lectures" />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Mastering Durham Law Lectures" />
        <meta name="twitter:description" content="Stop transcribing blindly. Learn the strategic workflow for Durham Law lectures." />
      ...
      <div className="bg-white min-h-screen py-12 lg:py-20">
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-lg prose-purple max-w-none text-gray-700">
            ...
            <p>
              Your lecturer isn't reading a textbook to you; they are creating a narrative. They are showing you how the law <em>fits together</em>.
            </p>
            ...
            <ul>
              <li><strong>Map the structure:</strong> Note the 3-4 main headings from the handout.</li>
              <li><strong>Identify key cases:</strong> Spot the names that keep appearing.</li>
              <li><strong>Formulate questions:</strong> What specific ambiguity does this lecture aim to resolve?</li>
            </ul>
            ...
            <div className="bg-purple-50 border-l-4 border-purple-500 p-4 my-6 rounded-r-lg">
              <h4 className="font-bold text-gray-900 mb-2 mt-0">Listen for these signals:</h4>
              <ul className="mb-0">
                <li><em>"The critical distinction here is..."</em> (This is likely an exam issue)</li>
                <li><em>"Students often confuse X with Y..."</em> (This is a common pitfall to avoid)</li>
                <li><em>"I personally find this judgment unconvincing..."</em> (Gold dust for critical analysis marks)</li>
              </ul>
            </div>
            ...
            <ul>
              <li><strong>Condense:</strong> Summarise the legal principle in one sentence.</li>
              <li><strong>Connect:</strong> Explicitly link this case to the one from last week.</li>
              <li><strong>Critique:</strong> Add a "Criticism" column next to the ratio decidendi.</li>
            </ul>
          ...
          <div className="mt-16 bg-gray-50 border border-gray-200 rounded-2xl p-8 text-center">
             <h3 className="text-2xl font-bold text-gray-900 mb-4">Put this into practice</h3>
          ...
          <div className="mt-16 pt-8 border-t border-gray-100">
             ...
             <div className="grid gap-6 md:grid-cols-2">
                <Link href="/learn/durham-assignments" className="group block p-6 border border-gray-100 rounded-xl hover:border-purple-200 hover:shadow-md transition">
                   ...
                   <p className="text-sm text-gray-600">Formative vs Summative workflows.</p>
                </Link>
                <Link href="/learn/durham-exam-prep" className="group block p-6 border border-gray-100 rounded-xl hover:border-purple-200 hover:shadow-md transition">
                   ...
                   <p className="text-sm text-gray-600">IRAC drills and honest revision.</p>
                </Link>
             </div>
          </div>
