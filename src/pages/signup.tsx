        ...
        <div className="max-w-4xl mx-auto px-6 w-full">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-gray-500 max-w-2xl mx-auto font-medium">
              {BRAND_NAME} is an independent study companion designed around the
              Durham Law journey. <br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Personalised help with your legal studies
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(
                    ["foundation", "year1", "year2", "year3"] as YearGroup[]
                  ).map((yg) => (
                    <button
                      key={yg}
                      type="button"
