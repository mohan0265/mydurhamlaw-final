...
export default function AWYSettingsPage() {
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.emailSent) {
        ...
        toast('Invitation created, but email failed to send. Please ask them to login directly.', {
          icon: '⚠️',
          duration: 5000
        })
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Head>
        <title>Family Settings - MyDurhamLaw</title>
      </Head>
        ...
        <div className="bg-white shadow rounded-2xl overflow-hidden">
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">Your Loved Ones</h2>
          ...
          <div className="p-6">
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mb-6">Add a loved one to get started.</p>
                <button
              ...
              <div className="space-y-6">
                  ...
                  <div key={conn.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{conn.loved_email}</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                ...
                {/* Add Form */}
                {isAdding && (
                  <form onSubmit={handleAdd} className="bg-pink-50 rounded-xl p-6 border border-pink-100 animate-in fade-in slide-in-from-top-4">
                    <h3 className="text-sm font-semibold text-pink-900 mb-4">Add New Connection</h3>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div>
                        <label className="block text-xs font-medium text-pink-800 mb-1">Email Address</label>
                        <input
                          type="email"
                          required
                          value={email}
                      ...
                      <div>
                        <label className="block text-xs font-medium text-pink-800 mb-1">Relationship</label>
                        <select
                          required
                          value={relationship}
                      ...
                      <div className="sm:col-span-2">
                        <label className="block text-xs font-medium text-pink-800 mb-1">Nickname (Optional)</label>
                        <input
                          type="text"
                          value={nickname}
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-100">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-xs text-gray-500">
                Your privacy is our priority. Loved ones can only see your status when you explicitly enable it. 
                They cannot access your grades, assignments, or private messages.
              </p>
            </div>
          </div>
        </div>
