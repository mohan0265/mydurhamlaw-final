...
export const guides: Guide[] = [
  ...
  {
    slug: "caseway-lexicon",
    href: "/articles/caseway-lexicon",
    canonicalPath: "https://casewaylaw.ai/articles/caseway-lexicon",
    title: "CASEWAY Lexicon™",
    description:
      "Master legal language and own the courtroom. Why legal terminology mastery starts with live listening.",
    category: ["Speaking", "Ethics"],
    readTime: "7 min read",
    publishedAt: "2026-01-31",
    featured: true,
    order: 1.1,
    type: "article",
    tags: ["lexicon", "terminology", "mastery", "ethics"],
  },
  {
    slug: "syllabus-shield",
    href: "/articles/syllabus-shield",
    canonicalPath: "https://casewaylaw.ai/articles/syllabus-shield",
    title: "SyllabusShield™",
    description:
      "Never miss a lecture. How to ensure 100% curriculum coverage while building professional focus.",
    category: ["Study Skills", "Ethics"],
    readTime: "8 min read",
    publishedAt: "2026-01-31",
    featured: true,
    order: 1.2,
    type: "article",
    tags: ["syllabus", "coverage", "ethics", "productivity"],
  },
  {
